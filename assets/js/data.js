...
const PUBS = [
  { y: 2026, theme: 'materials', title: 'Elastic properties of rubber-modified asphaltic concrete under various stress states', authors: 'C. Phutthananon, S. Youwai, P. Preeyanon, W. Kongkitkul, P. Jongpradist', venue: 'International Journal of Pavement Engineering, 27(1)', type: 'Journal', url: 'https://doi.org/10.1080/10298436.2026.2664623' },
  { y: 2026, theme: 'agentic', title: 'Large language model-based multi-agent systems for automated foundation design', authors: 'S. Youwai, D. Phim, V. G. Murcia, R. C. Onas', venue: 'AI in Civil Engineering, 5(1)', type: 'Journal', url: 'https://doi.org/10.1007/s43503-026-00088-8' },
  ...
  { y: 2026, theme: 'vision', title: 'YOLO26-RD: an end-to-end road damage detection network', authors: 'S. Youwai, P. Chaipetch, H. Samaikul, T. Yonseng', venue: 'arXiv:2608.15713', type: 'Preprint', url: 'https://arxiv.org/abs/2608.15713' },
  { y: 2026, theme: 'geophysics', title: 'TriView-YOLO: early multi-view fusion for ground penetrating radar cavity detection', authors: 'S. Thawinutchokaudom, S. Youwai, W. Kongkitkul, M. Yamashina, et al.', venue: 'arXiv:2608.09522', type: 'Preprint', url: 'https://arxiv.org/abs/2608.09522' },
  { y: 2026, theme: 'geophysics', title: 'A practical method for predicting pavement strains and overlay thickness', authors: 'C. Phutthananon, W. Kongkitkul, C. Wantanagun, J. Sunitsakul, S. Youwai, et al.', venue: 'Transportation Infrastructure Geotechnology, 13(6)', type: 'Journal', url: 'https://doi.org/10.1007/s40515-026-00964-x' },
  ...
  { y: 2026, theme: 'xai', title: 'Prediction of waste shear strength parameters in open dumps', authors: 'P. Suknark, S. Towprayoon, S. Youwai, C. Chiemchaisri, K. Wangyao', venue: 'Waste Management, 222', type: 'Journal', url: 'https://doi.org/10.1016/j.wasman.2026.115677' },
  { y: 2026, theme: 'pinn', title: 'Fourier feature physics-informed neural networks for elasto-plastic analysis', authors: 'A. Robjanghvad, S. Youwai', venue: 'arXiv:2607.25150', type: 'Preprint', url: 'https://arxiv.org/abs/2607.25150' },
  { y: 2025, theme: 'xai', title: 'Evaluation of shear strength parameters for municipal solid waste', authors: 'P. Suknark, S. Towprayoon, S. Youwai, C. Chiemchaisri, K. Wangyao', venue: 'Journal of Material Cycles and Waste Management, 27(6)', type: 'Journal', url: 'https://doi.org/10.1007/s10163-025-02400-7' },
  { y: 2025, theme: 'sequence', title: 'Artificial intelligence-optimized shield parameters for soft ground tunneling', authors: 'S. Wainiphithapong, C. Phutthananon, S. Youwai, P. Jamsawang, et al.', venue: 'Underground Space', type: 'Journal', url: 'https://doi.org/10.1016/j.undsp.2025.04.008' },
  { y: 2025, theme: 'agentic', title: 'Investigating the potential of large language model-based router multi-agent architectures', authors: 'S. Youwai, D. Phim, V. G. Murcia, R. C. Onas', venue: 'arXiv:2506.13811', type: 'Preprint', url: 'https://arxiv.org/abs/2506.13811' },
  { y: 2025, theme: 'xai', title: 'Developing an explainable artificial intelligence (XAI) model for predicting pile driving vibrations', authors: 'S. Youwai, A. Pamungmoon', venue: 'Neural Computing and Applications, 37(18)', type: 'Journal', url: 'https://doi.org/10.1007/s00521-025-11203-8' },
  { y: 2025, theme: 'materials', title: 'Strength and elastic properties of air&ndash;cement-treated clays', authors: 'C. Phutthananon, A. Songprom, R. Sukkarak, P. Jongpradist, W. Kongkitkul, S. Youwai', venue: 'Arabian Journal for Science and Engineering, 50(11)', type: 'Journal', url: 'https://doi.org/10.1007/s13369-024-09096-1' },
  { y: 2025, theme: 'materials', title: 'Triple attention transformer architecture for time-dependent concrete creep prediction', authors: 'W. Dokduea, W. Tangchirapat, S. Youwai', venue: 'arXiv:2506.04243', type: 'Preprint', url: 'https://arxiv.org/abs/2506.04243' },
  ...
  { y: 2025, theme: 'xai', title: 'Explainable dual-attention tabular transformer for soil electrical resistivity prediction', authors: 'W. Kongkitkul, S. Youwai, W. Sakulpojworachai', venue: 'arXiv:2504.02834', type: 'Preprint', url: 'https://arxiv.org/abs/2504.02834' },
  ...
  { y: 2025, theme: 'sequence', title: 'Predicting rapid impact compaction of soil using a parallel transformer and long short-term memory architecture', authors: 'S. Youwai, S. Detcheewa', venue: 'Engineering Applications of Artificial Intelligence, 139', type: 'Journal', url: 'https://doi.org/10.1016/j.engappai.2024.109664' },
  { y: 2024, theme: 'vision', title: 'A fused deep learning expert system for road damage detection and size analysis', authors: 'S. Youwai, A. Chaiyaphat, P. Chaipetch', venue: 'Int. Conf. on Intelligent Computing and Next Generation Networks', type: 'Conference', url: 'https://doi.org/10.1109/ICNGN63705.2024.10871286' },
  { y: 2024, theme: 'xai', title: 'Explainable artificial intelligence (XAI) for predicting asphalt concrete stiffness and rutting resistance', authors: 'W. Kongkitkul, S. Youwai, S. Khamsoy, M. Feungfung', venue: 'arXiv:2410.21298', type: 'Preprint', url: 'https://arxiv.org/abs/2410.21298' },
  { y: 2024, theme: 'vision', title: 'YOLO9tr: a lightweight model for pavement damage detection utilizing a generalized efficient layer aggregation network and attention mechanism', authors: 'S. Youwai, A. Chaiyaphat, P. Chaipetch', venue: 'Journal of Real-Time Image Processing, 21(5)', type: 'Journal', url: 'https://doi.org/10.1007/s11554-024-01545-2' },
  { y: 2025, theme: 'safety', title: 'A random forest and SHAP-based analysis of motorcycle crash severity in Thailand', authors: 'S. Sum, C. Se, T. Champahom, S. Jomnonkwao, S. Sinha, V. Ratanavaraha', venue: 'Transportation Engineering', type: 'Journal', url: 'https://doi.org/10.1016/j.treng.2025.100369' },
  { y: 2025, theme: 'safety', title: 'SHAP-based convolutional neural network modeling for intersection crash severity', authors: 'J. Sunkpho, C. Se, W. Wipulanusat, V. Ratanavaraha', venue: 'IATSS Research', type: 'Journal', url: 'https://doi.org/10.1016/j.iatssr.2024.12.003' },
  { y: 2024, theme: 'safety', title: 'XGBoost-SHAP and unobserved heterogeneity modelling of temporal multivehicle truck-involved crash severity patterns', authors: 'W. Laphrom, C. Se, T. Champahom, S. Jomnonkwao, W. Wipulanusat, T. Satiennam, V. Ratanavaraha', venue: 'Civil Engineering Journal', type: 'Journal', url: 'https://doi.org/10.28991/CEJ-2024-010-06-011' },
  { y: 2024, theme: 'safety', title: 'Tree-based approaches to understanding factors influencing crash severity across roadway classes: a Thailand case study', authors: 'T. Champahom, C. Se, F. Watcharamaisakul, S. Jomnonkwao, A. Karoonsoontawong, V. Ratanavaraha', venue: 'IATSS Research', type: 'Journal', url: 'https://doi.org/10.1016/j.iatssr.2024.09.001' },
  { y: 2024, theme: 'safety', title: 'Modeling motorcycle crash-injury severity using explainable data-driven approaches', authors: 'C. Se, J. Sunkpho, W. Wipulanusat, K. Tantisevi, T. Champahom, V. Ratanavaraha', venue: 'Transportation Letters', type: 'Journal', url: 'https://doi.org/10.1080/19427867.2024.2408920' },
  { y: 2026, theme: 'safety', title: 'Temporal instability of highway pedestrian crash severity: comparative analysis of machine learning models', authors: 'P. Wisutwattanasak, C. Se, S. Sum, T. Champahom, V. Ratanavaraha, S. Jomnonkwao', venue: 'Transportation Research Interdisciplinary Perspectives', type: 'Journal', url: 'https://doi.org/10.1016/j.trip.2026.101935' },
  { y: 2025, theme: 'safety', title: 'Deep learning vs. gradient boosting: optimizing transport energy forecasts in Thailand through LSTM and XGBoost', authors: 'T. Champahom, C. Banyong, T. Janhuaton, C. Se, F. Watcharamaisakul, V. Ratanavaraha, S. Jomnonkwao', venue: 'Energies', type: 'Journal', url: 'https://doi.org/10.3390/en18071685' },
  { y: 2025, theme: 'safety', title: 'Pickup truck crash severity analysis via machine learning: policy insights for developing countries', authors: 'C. Se, T. Champahom, S. Jomnonkwao, T. Boonyoo, A. Karoonsoontawong, V. Ratanavaraha', venue: 'International Journal of Injury Control and Safety Promotion', type: 'Journal', url: 'https://doi.org/10.1080/17457300.2025.2504975' },
  { y: 2025, theme: 'safety', title: 'XGBoost-based prediction model for train passenger numbers: evaluating the effect of the COVID-19 pandemic', authors: 'C. Se, T. Champahom, S. Jomnonkwao, V. Ratanavaraha', venue: 'Communications in Computer and Information Science', type: 'Conference', url: 'https://doi.org/10.1007/978-981-96-6948-6_31' },
  { y: 2022, theme: 'safety', title: 'Motorcyclist injury severity analysis: a comparison of artificial neural networks and a random parameter model with heterogeneity in means and variances', authors: 'C. Se, T. Champahom, S. Jomnonkwao, V. Ratanavaraha', venue: 'International Journal of Injury Control and Safety Promotion', type: 'Journal', url: 'https://doi.org/10.1080/17457300.2022.2081985' },
  { y: 2026, theme: 'water', title: 'Enhancing flood forecasting with deep learning: a scalable alternative to traditional hydrodynamic models', authors: 'W. Duangkhwan, C. Ekkawatpanit, C. Petpongpan, D. Kositgittiwong, S. Kazama, Y. Hiraga, C. Jaturapitakkul', venue: 'Environmental Modelling &amp; Software', type: 'Journal', url: 'https://doi.org/10.1016/j.envsoft.2025.106841' },
  ...
  { y: 2026, theme: 'shm', title: 'Cyclic drift capacity and modeling of slab-column connections with and without shear reinforcement', authors: 'K. Akanit, E. Junda, S. Leelataviwat, K. Chawgien, S. Kiatmetha', venue: 'Engineering Structures, 365', type: 'Journal', url: 'https://doi.org/10.1016/j.engstruct.2026.123174' },
  { y: 2026, theme: 'shm', title: 'Seismic performance and possible damage scenario of an ancient Thai pagoda in Chiang Saen District, Northern Thailand', authors: 'K. Jintrakham, P. Mahasuwanchai, W. Wararuksajja, C. Athisakul, T. Ornthammarath, P. Jongpradist, S. Leelataviwat', venue: 'Results in Engineering', type: 'Journal', url: 'https://doi.org/10.1016/j.rineng.2026.110821' },
  { y: 2026, theme: 'shm', title: 'Tunnel deformation monitoring during construction using 3D laser scanning technology', authors: 'A. Intham, P. Jongpradist, C. Binzaits, P. Mahasuwanchai, P. Kungsuwan, A. Thuaksiri', venue: 'Connecting Communities Through Underground Infrastructure', type: 'Conference', url: 'https://doi.org/10.1201/9781042001064-167' },
  { y: 2025, theme: 'shm', title: 'Nonlinear finite element modeling and seismic analysis of Thai historical masonry wall structures', authors: 'F. Wu, C. Athisakul, P. Mahasuwanchai, C. Phansangud, S. Leelataviwat, K. Jintrakham, W. Wen, H. Yang', venue: 'IOP Conference Series: Earth and Environmental Science', type: 'Conference', url: 'https://doi.org/10.1088/1755-1315/1500/1/012057' },
  { y: 2025, theme: 'shm', title: 'Building data acquisition and seismic performance evaluation of a traditional Thai water tower using 3D laser scanning', authors: 'F. Wu, C. Athisakul, T. Srimontriphakdi, C. Binzaits, P. Mahasuwanchai, S. Leelataviwat', venue: 'IOP Conference Series: Earth and Environmental Science', type: 'Conference', url: 'https://doi.org/10.1088/1755-1315/1500/1/012056' },
  { y: 2024, theme: 'shm', title: 'Long-term monitoring and finite element analysis of the Pasana Chedi, Wat Ratchapradit Sathimahasimaram', authors: 'C. Binzaits, P. Mahasuwanchai, C. Athisakul, S. Leelataviwat, S. Chucheepsakul, C. Tingsanchali, C. Sudthongkhong', venue: "The Journal of King Mongkut's University of Technology North Bangkok", type: 'Journal', url: 'https://doi.org/10.14416/j.kmutnb.2024.09.016' },
  { y: 2023, theme: 'shm', title: 'A non-contact approach for cable tension evaluation based on 3D laser scanning data and nonlinear finite element analysis', authors: 'T. Srimontriphakdi, P. Mahasuwanchai, C. Athisakul, S. Leelataviwat, K. Klaycham, N. Poovarodom, N. Magteppong, S. Chucheepsakul', venue: 'Measurement', type: 'Journal', url: 'https://doi.org/10.1016/j.measurement.2023.112680' },
  { y: 2021, theme: 'shm', title: 'An alternative method for long-term monitoring of Thai historic pagodas based on terrestrial laser scanning data: a case study of Wat Krachee in Ayutthaya', authors: 'P. Mahasuwanchai, C. Athisakul, P. Sairuamyat, W. Tangchirapat, S. Leelataviwat, S. Chucheepsakul', venue: 'Advances in Civil Engineering', type: 'Journal', url: 'https://doi.org/10.1155/2021/5587046' },
  { y: 2020, theme: 'shm', title: 'Application of 3D laser scanning technology for preservation and monitoring of a Thai pagoda', authors: 'P. Sairuamyat, P. Mahasuwanchai, C. Athisakul, S. Leelataviwat, S. Chucheepsakul', venue: 'IOP Conference Series: Earth and Environmental Science', type: 'Conference', url: 'https://doi.org/10.1088/1755-1315/463/1/012082' },
  { y: 2015, theme: 'legacy', title: 'High internal pressure induced fracture patterns in rock masses surrounding caverns', authors: 'P. Jongpradist, J. Tunsakul, W. Kongkitkul, N. Fadsiri, G. Arangelovski, S. Youwai', venue: 'Engineering Geology, 197', type: 'Journal', url: 'https://doi.org/10.1016/j.enggeo.2015.08.024' },
  { y: 2013, theme: 'legacy', title: 'Development of tunneling influence zones for adjacent pile foundations by numerical analyses', authors: 'P. Jongpradist, T. Kaewsri, A. Sawatparnich, S. Suwansawat, S. Youwai, et al.', venue: 'Tunnelling and Underground Space Technology, 34', type: 'Journal', url: 'https://doi.org/10.1016/j.tust.2012.11.005' },
  { y: 2003, theme: 'legacy', title: 'Strength and deformation characteristics of shredded rubber tire sand mixtures', authors: 'S. Youwai, D. T. Bergado', venue: 'Canadian Geotechnical Journal, 40(2)', type: 'Journal', url: 'https://doi.org/10.1139/t02-104' }
];
